...
@section('title','B5 Store|| PRODUCT PAGE')
                                ...
                                <div class="single-widget recent-post">
                                    ...
                                    @foreach($recent_products as $product)
                                        ...
                                        <div class="single-post first">
                                            <div class="image">
                                                <img style="max-height: 200px" src="{{$photo[0]}}" alt="{{$photo[0]}}">
                                            </div>
                                            <div class="content">
                                            ...
                                            <div class="product-img">
                                                <a href="{{route('product-detail',$product->slug)}}">
                                                    @php
                                                        $photo=explode(',',$product->photo);
                                                    @endphp
                                                    <img style="max-height: 200px" class="default-img" src="{{$photo[0]}}" alt="{{$photo[0]}}">
